...
TELEGRAM_BOT_TOKEN = env_str("TELEGRAM_BOT_TOKEN", required=False)
TELEGRAM_CHAT_ID = env_str("TELEGRAM_CHAT_ID", required=False)
CRITICAL_LIGHTS_WEBHOOK_URL = env_str("CRITICAL_LIGHTS_WEBHOOK_URL", required=False)
CRITICAL_LIGHTS_ACTION_NAME = env_str("CRITICAL_LIGHTS_ACTION_NAME")
CRITICAL_LIGHTS_COOLDOWN = env_float("CRITICAL_LIGHTS_COOLDOWN")
CRITICAL_LIGHTS_TIMEOUT = env_float("CRITICAL_LIGHTS_TIMEOUT")
CRITICAL_LIGHTS_OFF_WEBHOOK_URL = env_str("CRITICAL_LIGHTS_OFF_WEBHOOK_URL", required=False)
CRITICAL_LIGHTS_OFF_ACTION_NAME = env_str("CRITICAL_LIGHTS_OFF_ACTION_NAME")
CRITICAL_LIGHTS_AUTO_OFF_SECONDS = env_float("CRITICAL_LIGHTS_AUTO_OFF_SECONDS")
ENABLE_OMNISTATUS = env_bool("ENABLE_OMNISTATUS")
OMNISTATUS_API = env_str("OMNISTATUS_ENDPOINT", required=False)
OMNISTATUS_DEDUP_ENABLED = env_bool("OMNISTATUS_DEDUP_ENABLED")
OMNISTATUS_DEDUP_WINDOW_SECONDS = env_float("OMNISTATUS_DEDUP_WINDOW_SECONDS")
OMNISTATUS_DEDUP_MAX_SAMPLES = env_int("OMNISTATUS_DEDUP_MAX_SAMPLES")
...
def process_camera_analysis(stream: CameraStream):
    ...
    critical_action_state = {"lights": 0.0, "tts": 0.0, "siren": 0.0, "lights_off_generation": 0}
